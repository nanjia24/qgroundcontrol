...
public:
    ...
    bool positionNormalizedValid() const { return _positionNormalizedValid; }
...
private:
    ...
    void _confirmReboot();
    void _acceptStatus(const mavlink_hybrid_vehicle_status_t& status);
    ...
    bool _positionNormalizedValid = false;
