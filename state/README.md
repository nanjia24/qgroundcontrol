...
- The already-published combined MAVLink tag `qgc-hybrid-rover-tuning-v1.16.1-r1` is protected by active GitHub ruleset `22006870` and peels to `21922689c6fb113884df0f66582d8e602286fdc1`. It descends from qgc_hybrid r2, retains APM and Hybrid definitions, excludes Storm32, and adds Rover tuning IDs `60100..60103` with required LEN/CRC values.
...
- Fresh Windows Debug configuration resolves VS2022 x64 `cl/link/lib`, keeps the ArduPilot dialect and plugin enabled, selects `qgc_hybrid` MAVLink 2, and checks out immutable tag `qgc-hybrid-rover-tuning-v1.16.1-r1` at `21922689c6fb113884df0f66582d8e602286fdc1`.
