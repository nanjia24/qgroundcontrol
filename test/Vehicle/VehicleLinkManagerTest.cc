...
void VehicleLinkManagerTest::_setMessageIntervalQueueIsolationTest()
{
    ...
    commandQueue->sendCommandWithHandlerOnLink(nullptr, mockLink1, componentId,
                                                MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_ATTITUDE, 20000);
    commandQueue->sendCommandWithHandlerOnLink(nullptr, mockLink2, componentId,
    ...
    QTRY_COMPARE_WITH_TIMEOUT(
        firstMockLink->receivedMavCommandCount(MockLink::MAV_CMD_MOCKLINK_ALWAYS_RESULT_ACCEPTED), 1,
        TestTimeout::shortMs());
    QTRY_VERIFY_WITH_TIMEOUT(
        !commandQueue->isPending(componentId, MockLink::MAV_CMD_MOCKLINK_ALWAYS_RESULT_ACCEPTED),
        TestTimeout::shortMs());
...
void VehicleLinkManagerTest::_setMessageIntervalLateAckQuarantineTest()
{
    ...
    commandQueue->sendCommandWithHandlerOnLink(nullptr, mockLink, componentId,
                                                MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_ATTITUDE, 20000);
    commandQueue->sendCommandWithHandlerOnLink(nullptr, mockLink, componentId,
                                                MAV_CMD_SET_MESSAGE_INTERVAL,
                                                MAVLINK_MSG_ID_LOCAL_POSITION_NED, 20000);
    ...
    commandQueue->sendCommandWithHandlerOnLink(nullptr, mockLink, componentId,
                                                MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_VFR_HUD, 20000);
...
void VehicleLinkManagerTest::_pendingSetMessageIntervalDisconnectFailsOverTest()
{
    ...
    QTRY_COMPARE_WITH_TIMEOUT(originalMockLink->receivedMavCommandCount(MAV_CMD_SET_MESSAGE_INTERVAL), 1,
                              TestTimeout::shortMs());
    commandQueue->sendCommandWithHandlerOnLink(nullptr, originalPrimary, componentId,
                                                MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_HIGHRES_IMU, 50000);
    QCOMPARE(originalMockLink->receivedMavCommandCount(MAV_CMD_SET_MESSAGE_INTERVAL), 1);
