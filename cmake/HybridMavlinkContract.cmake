...
function(qgc_validate_hybrid_mavlink_inputs)
    ...
    if(NOT "${QGC_MAVLINK_GIT_TAG}" STREQUAL "qgc-hybrid-rover-tuning-v1.16.1-r2")
        message(FATAL_ERROR "QGC_MAVLINK_GIT_TAG must be qgc-hybrid-rover-tuning-v1.16.1-r2")
    endif()
...
function(qgc_verify_hybrid_mavlink_checkout source_dir)
    ...
    if(NOT git_result EQUAL 0 OR NOT "${resolved_commit}" STREQUAL "ec506d609e775035b7c8ed37f09ef05774409281")
        message(FATAL_ERROR "CPM MAVLink checkout does not match the qgc_hybrid Rover tuning r2 peeled commit")
    endif()
endfunction()
